...
echo "API Explorer   http://$CLUSTERIP:$INGRESS_PORT/openapi/ui"
echo "REST API       http://$CLUSTERIP:$INGRESS_PORT/web-api/v1/getmultiple"
...
echo "watch -n 1 curl http://$CLUSTERIP:$INGRESS_PORT/web-api/v1/getmultiple"
echo "----------------------------------------------------------------------"
